...
export const metadata: Metadata = {
  ...
  description:
    "Meet the Go Foreign Brand Ambassadors — your trusted introduction to Brazil's culture, nightlife, and local life.",
};

const ambassadors = [
  { name: "Katherine", image: "/ambassadors/katherine.jpeg", slug: "katherine", available: true },
  { name: "Ambassador 2", image: "/ambassadors/placeholder.jpeg", slug: "ambassador-2", available: false },
  { name: "Ambassador 3", image: "/ambassadors/placeholder.jpeg", slug: "ambassador-3", available: false },
  { name: "Ambassador 4", image: "/ambassadors/placeholder.jpeg", slug: "ambassador-4", available: false },
  { name: "Ambassador 5", image: "/ambassadors/placeholder.jpeg", slug: "ambassador-5", available: false },
];
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {ambassadors.map((ambassador) => {
              ...
              const className =
                "group overflow-hidden rounded-3xl border border-[#C99A2E]/20 bg-zinc-950 transition duration-500 hover:-translate-y-2 hover:border-[#C99A2E] hover:shadow-2xl hover:shadow-[#C99A2E]/20";

              return ambassador.available ? (
                <a key={ambassador.slug} href={`/brand-ambassadors/${ambassador.slug}`} className={className}>
                  {card}
                </a>
              ) : (
                <div key={ambassador.slug} className={className}>
                  {card}
                </div>
              );
            })}
