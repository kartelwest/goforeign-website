...
export const metadata: Metadata = {
  title: "Go Foreign | Lifestyle Consulting & Relocation to Brazil",
  description:
    "Go Foreign is a lifestyle management consulting firm helping you relocate, build your brand, and live abroad in Brazil with confidence. Book a consultation today.",
  alternates: { canonical: "/" },
  openGraph: {
    title: "Go Foreign | Lifestyle Consulting & Relocation to Brazil",
    description:
      "Lifestyle consulting, relocation guidance, and marketing support for people ready to stop dreaming and start living abroad.",
    url: "/",
    type: "website",
  },
};
