  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      >
        ...
        <div className="relative z-10 mt-16 max-w-2xl animate-fade-up">
          ...
          <div className="mt-10 flex items-center gap-4">
            <div className="text-2xl text-[#C99A2E]">★★★★★</div>
      ...
      <section id="lifestyle" className="bg-black px-10 py-24 text-white">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {lifestyleHighlights.map(([image, title, text]) => (
              <div
                key={title}
      ...
      <section id="contact" className="bg-zinc-950 px-10 py-24">
        <div className="mx-auto max-w-4xl rounded-3xl border border-[#C99A2E]/30 bg-black p-10 text-center md:p-16">
          <p className="mb-4 font-bold uppercase tracking-[0.3em] text-[#C99A2E]">
            Get In Touch
          </p>
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-gray-300">
            Tell us about your move — timeline, destination, and what you need help
            with — and we&apos;ll follow up to plan your next steps.
          </p>

          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <a
              href="mailto:info@goforeign.com?subject=Consultation Request"
